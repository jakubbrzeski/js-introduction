...
tasks.add("dicrete knapsack problem", {
  ...
  tests: function(){
    test('test f', function(){
      ...
      strictEqual(f(14,35,[8,23,10,5,24,11,28,20,10,6,17,13,3,1],[8,12,3,11,14,13,1,13,9,1,6,16,20,17]), 73, 'test 1');
      strictEqual(f(14,31,[29,16,2,26,23,3,14,10,31,11,7,19,25,17],[7,12,7,13,5,20,5,13,20,2,20,19,18,6]), 66, 'test 2');
      strictEqual(f(10,30,[9,5,4,20,22,18,5,30,20,2],[5,9,1,3,20,7,7,4,18,3]), 32, 'test 3');
      ...
      strictEqual(f(16,30,[8,15,17,12,7,3,26,25,13,9,23,8,27,12,8,7],[17,13,19,5,14,8,2,16,15,11,1,14,19,3,18,18]), 61, 'test 6');
      strictEqual(f(13,38,[12,25,15,35,5,17,16,25,10,37,17,38,6],[20,19,7,19,12,2,13,14,15,18,4,9,15]), 47, 'test 7');
      strictEqual(f(15,37,[23,21,12,32,25,32,21,22,15,36,3,11,12,1,9],[7,7,18,18,20,11,4,6,20,7,14,15,8,12,6]), 55, 'test 8');
      ...
      strictEqual(f(11,18,[6,11,4,1,18,8,10,9,8,14,16],[9,7,8,17,16,7,10,4,2,11,10]), 34, 'test 10');
